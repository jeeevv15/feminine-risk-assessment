...
# Patch missing module for old sklearn model compatibility
_fake = types.ModuleType("sklearn.ensemble._gb_losses")
sys.modules["sklearn.ensemble._gb_losses"] = _fake
